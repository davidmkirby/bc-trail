/****************************************************************************
** Meta object code from reading C++ file 'gimbal_controller.h'
**
...
#include "../../../include/gimbal_controller.h"
...
#error "The header file 'gimbal_controller.h' doesn't include <QObject>."
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGimbalControllerENDCLASS_t qt_meta_stringdata_CLASSGimbalControllerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(17, 13),  // "statusChanged"
        QT_MOC_LITERAL(31, 0),  // ""
...
void GimbalController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GimbalController::statusChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GimbalController::*)(const QString & );
            if (_t _q_method = &GimbalController::errorOccurred; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GimbalController::statusChanged(const QString & _t1)
{
...
// SIGNAL 1
void GimbalController::errorOccurred(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
